# 📘 Aula 02 — Introdução ao JavaScript e Node.js

Exercícios da disciplina de Linguagens de Programação — ADS Fatec Indaiatuba.

## 📝 Exercícios

- [x] Exercício 1 - Configuração do projeto
- [x] Exercício 2 - Calculadora simples
- [x] Exercício 3 - Perfil do aluno
- [x] Exercício 4 - Conversor de temperatura
